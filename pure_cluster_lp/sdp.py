...
###########################################################
	...
	# verbose=True outputs to stderr, which goes to .err file in SLURM
	# If you want verbose output in .out file, redirect stderr in SLURM script: python3 sdp.py ... 2>&1
